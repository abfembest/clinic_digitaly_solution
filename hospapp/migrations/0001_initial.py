    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test_category', models.CharField(default='empty', max_length=100)),
                ('result_value', models.TextField(default='positive')),
                ('normal_range', models.CharField(blank=True, max_length=100, null=True)),
                ('notes', models.TextField(blank=True, null=True)),
                ('date_performed', models.DateTimeField(default=datetime.time(19, 14, 43, 115376))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('partial', 'Partially Paid'), ('paid', 'Fully Paid'), ('cancelled', 'Cancelled'), ('refunded', 'Refunded')], default='pending', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('notes', models.TextField(blank=True, null=True)),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.DecimalField(decimal_places=2, max_digits=10, validators=[django.core.validators.MinValueValidator(Decimal('0.01'))])),
                ('payment_method', models.CharField(choices=[('cash', 'Cash'), ('pos', 'POS'), ('transfer', 'Bank Transfer'), ('cheque', 'Cheque'), ('online', 'Online Payment')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('receptionist', 'Receptionist'), ('nurse', 'Nurse'), ('doctor', 'Doctor'), ('lab', 'Lab Technician'), ('admin', 'Administrator'), ('pharmacy', 'Pharmacy'), ('hr', 'HR'), ('account', 'Account')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='test_selections', to='hospapp.patient')),
            ],
        ),
        migrations.AddField(
            model_name='labtest',
